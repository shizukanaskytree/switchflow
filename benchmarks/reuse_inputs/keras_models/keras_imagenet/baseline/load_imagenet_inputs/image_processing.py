...
def preprocess_for_train(image,
  ...
  with tf.name_scope(scope, 'distort_image', [image, height, width, bbox]):
    ...
    # wxf: add some random preprocessing
    #for i in range(600):
    #  distorted_image = tf.multiply(distorted_image, 1.1)
    #  distorted_image = tf.subtract(distorted_image, 0.02)
    # 34.361 sec vs 10.00 sec

    #distorted_image = tf.image.adjust_gamma(distorted_image, 0.2)
    #distorted_image = tf.image.adjust_saturation(distorted_image, 3)
    #distorted_image = tf.image.adjust_brightness(distorted_image, 0.4)
    #distorted_image = tf.image.random_brightness(distorted_image, max_delta=0.5)  # Random brightness
